          ...
          <tr>
            <td align="center">
              <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff; border-radius:8px; overflow:hidden;">
                  ...
                  <td style="padding:30px; color:#333333;">
                    ...
                    <div style="text-align:center; margin:30px 0;">
                      <a href="${verificationUrl}"
                         style="background-color:#2563eb; color:#ffffff; padding:14px 28px; text-decoration:none; border-radius:6px; display:inline-block;">
                        Verify Email
                      </a>
                    </div>
                ...
                <!-- Footer -->
                <tr>
                  <td style="background-color:#f9fafb; padding:15px; text-align:center; font-size:12px; color:#777;">
